...
import com.heartsteel.heartory.databinding.FragmentExerciseItemRecommendationCardBinding
...
class ExerciseRecommendationAdapter(
    private var items: List<Exercise>,
    private val onItemClick: (Exercise) -> Unit
) : RecyclerView.Adapter<ExerciseRecommendationAdapter.ViewHolder>() {

    class ViewHolder(private val binding: FragmentExerciseItemRecommendationCardBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = FragmentExerciseItemRecommendationCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
